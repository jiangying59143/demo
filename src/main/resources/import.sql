...
INSERT INTO `article` (`id`, `create_by`, `create_date`, `update_by`, `update_date`, `version`, `article_type`, `privilege`, `title`, `weight`, `article_body1_id`, `article_body3_id`, `comments_count_id`, `thumbs_down_count_id`, `thumbs_up_count_id`, `article_video_body_id`, `view_count_id`, `author_user_id`, `location_id`) VALUES (1, NULL, '2018-09-05 21:46:19', NULL, NULL, 1, 3, 1, '7月以来6省份党委组织部长调整：辽宁王正谱任四川省委常委', 0, NULL, 1, NULL, NULL, NULL, NULL, NULL, 2, NULL);
INSERT INTO `article` (`id`, `create_by`, `create_date`, `update_by`, `update_date`, `version`, `article_type`, `privilege`, `title`, `weight`, `article_body1_id`, `article_body3_id`, `comments_count_id`, `thumbs_down_count_id`, `thumbs_up_count_id`, `article_video_body_id`, `view_count_id`, `author_user_id`, `location_id`) VALUES (2, NULL, '2018-09-05 21:46:19', NULL, NULL, 1, 3, 1, 'title2', 0, NULL, 2, NULL, NULL, NULL, NULL, NULL, 2, NULL);
INSERT INTO `article` (`id`, `create_by`, `create_date`, `update_by`, `update_date`, `version`, `article_type`, `privilege`, `title`, `weight`, `article_body1_id`, `article_body3_id`, `comments_count_id`, `thumbs_down_count_id`, `thumbs_up_count_id`, `article_video_body_id`, `view_count_id`, `author_user_id`, `location_id`) VALUES (3, NULL, '2018-09-05 21:46:19', NULL, NULL, 1, 3, 1, 'title3', 0, NULL, 3, NULL, NULL, NULL, NULL, NULL, 2, NULL);
INSERT INTO `article` (`id`, `create_by`, `create_date`, `update_by`, `update_date`, `version`, `article_type`, `privilege`, `title`, `weight`, `article_body1_id`, `article_body3_id`, `comments_count_id`, `thumbs_down_count_id`, `thumbs_up_count_id`, `article_video_body_id`, `view_count_id`, `author_user_id`, `location_id`) VALUES (4, NULL, '2018-09-05 21:46:31', NULL, '2018-09-05 21:46:31', 1, 1, 1, '“警察叔叔，我爸爸妈妈走丢了”……', 2, NULL, 4, 1, 1, 1, NULL, 1, 2, NULL);

INSERT INTO `article_category` (`article_id`, `category_id`) VALUES (4, 4);
