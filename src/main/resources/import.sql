...
INSERT INTO `article` (`id`, `author_user_id`, privilege, article_type, `create_date`, `weight`, `category_id`, `title`, `article_Body3_Id`) VALUES (1, 2, 1, 3, sysdate(), 0, 1, '7月以来6省份党委组织部长调整：辽宁王正谱任四川省委常委', 1);
INSERT INTO `article` (`id`, `author_user_id`, privilege, article_type, `create_date`, `weight`, `category_id`, `title`, `article_Body3_Id`) VALUES (2, 2, 1, 3, sysdate(), 0, 2, 'title2', 2);
INSERT INTO `article` (`id`, `author_user_id`, privilege, article_type, `create_date`, `weight`, `category_id`, `title`, `article_Body3_Id`) VALUES (3, 2, 1, 3, sysdate(), 0, 3, 'title3', 3);
