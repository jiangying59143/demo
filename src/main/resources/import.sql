...
INSERT INTO `article` (`id`, `author_user_id`, privilege, article_type, `create_date`, `weight`, `author_user_id`,  `category_id`, `summary`, `title`) VALUES (1, 2, 1, 2, sysdate(), 0, 1, '7月以来6省份党委组织部长调整：辽宁王正谱任四川省委常委', '7月以来6省份党委组织部长调整：辽宁王正谱任四川省委常委');
INSERT INTO `article` (`id`, `author_user_id`, privilege, article_type, `create_date`, `weight`, `author_user_id`,  `category_id`, `summary`, `title`) VALUES (2, 2, 1, 2, sysdate(), 0, 2, 'summary2', 'title2');
INSERT INTO `article` (`id`, `author_user_id`, privilege, article_type, `create_date`, `weight`, `author_user_id`,  `category_id`, `summary`, `title`) VALUES (3, 2, 1, 2, sysdate(), 0, 3, 'summary3', 'title3');
